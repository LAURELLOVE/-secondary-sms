...
self.addEventListener('fetch', (event) => {
  ...
  // Pages: try the network so a new deploy shows up at once, fall back to the cached shell offline.
  ...
  // Built assets (hashed file names) and icons: cache first, fill on miss.
  event.respondWith(
