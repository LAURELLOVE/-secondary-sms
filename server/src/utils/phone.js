...
// (covers MTN, Orange, and Nexttel prefixes). Accepts common input styles
// (with/without +, with a leading 0, with spaces or dashes) and normalizes
// them all to the canonical +2376XXXXXXXX form used for storage and lookup.
